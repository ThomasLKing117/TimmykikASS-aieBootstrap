...
int main()
{
	...
	Attack dameonAttacks[4] = { shadowBurst, undeadCasting, necromancingStorm, apocalypticPlague };
														 ...
														 //H	//D  //S  //A	//P
	Enemy enemy1("The Juggler",jugglerAttacks,			  100.0, 5.0, .2,  20,90, 1);
	Enemy enemy2("Kusunoki Masashige", kusunokiAttacks,	  150.0, 20.0,.15, 15,93, 2);
	Enemy enemy3("Jann", jannAttacks,					  300.0, 35.0, .1, 10,90, 3);
	Enemy enemy4("Deogen", deogenAttacks,				  350.0, 15.0, .1,  5,85, 4);
	Enemy enemy5("George Sands", georgeAttacks,			  400.0, 40.0,.16, 30,95, 5);
	Enemy boss("Dameon The Necromancer", dameonAttacks,   400.0, 24.0, .3, 35,80, 6);
